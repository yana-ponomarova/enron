...
spark-submit ./Code/LDA_model_main.py "/home/datascience/enron" "/Data/mail-2015.avro"  "/src/stopwords_eng.txt" "/src/CSV_Database_of_First_Names.csv" "/src/CSV_Database_of_Last_Names.csv"
...
path_emails_rescaled_byauthor = path_global + "/src/emails_rescaled_byauthor"
path_docs = path_global + "/src/docs.csv"
path_lda_models_test = path_global + "/LDA_models.txt"
path_mentee = path_global + "/src/mentee.txt"
path_emails_rescaled_byauthor = path_global + "/src/emails_rescaled_byauthor"
path_result_lda = path_global + "/Result/result_lda.csv"
path_ldamodel = path_global + "/Model/lda_model13.txt"
...
ldamodel = gensim.models.ldamodel.LdaModel(train_set_lda, num_topics= 13, id2word = dictionary, passes= 20)
ldamodel.save(path_ldamodel)
dictionary.save(path_lda_dictionary)
corpora.MmCorpus.serialize(path_lda_corpora, corpus) 

emails_dedup_cleaned_dedup_chunk_collect = emails_dedup_cleaned_dedup_chunk.select("from").collect()
